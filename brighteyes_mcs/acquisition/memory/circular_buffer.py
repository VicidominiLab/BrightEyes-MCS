...
class CircularSharedBuffer:
    ...
    def put(self, value):
        ...
        # debug("CircularShardBuffer - get()")
        #debug("available_data",self.available_data, self.size, self.available_data/self.size )
        #
        # print("CircularShardBuffer - put()")
        # debug("self.size",  self.size)
        # debug("self.head.value", self.head.value)
        # debug("self.tail.value", self.tail.value)
        # debug("self.available_space()", self.available_space)
